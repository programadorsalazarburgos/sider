...
(function($) {
	...
	var defaults_extended = {
		...
		holidays:  {
			...
			// Third (+3*) Monday (1) in Enero (01)
			'01+3*1': "Birthday of Dr. Martin Luther King, Jr.",
			// Third (+3*) Monday (1) in Febrero (02)
			'02+3*1': "Washington's Birthday",
			// Last (-1*) Monday (1) in May (05)
			'05-1*1': "Memorial Day",
			// Julio 4
			'04-07':  "Independence Day",
			// First (+1*) Monday (1) in Septiembre (09)
			'09+1*1': "Labor Day",
			// Second (+2*) Monday (1) in Octubre (10)
			'10+2*1': "Columbus Day",
			// Noviembre 11
			'11-11':  "Veterans Day",
			// Fourth (+4*) Thursday (4) in Noviembre (11)
