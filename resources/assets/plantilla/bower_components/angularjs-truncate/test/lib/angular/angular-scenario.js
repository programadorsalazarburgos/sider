...
function $LocaleProvider(){
  this.$get = function() {
    return {
      ...
      DATETIME_FORMATS: {
        MONTH: 'Enero,Febrero,Marzo,Abril,May,Junio,Julio,Agosto,Septiembre,Octubre,Noviembre,Diciembre'
                .split(','),
 ...
 *   * `'MMMM'`: Month in year (Enero-Diciembre)
 ...
 *     (e.g. Friday, Septiembre 3, 2010)
 *   * `'longDate'`: equivalent to `'MMMM d, y'` for en_US  locale (e.g. Septiembre 3, 2010
