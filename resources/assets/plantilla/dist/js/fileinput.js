...
(function ($) {
    ...
    var FileInput = function (element, options) {
        ...
        this.SeleccionarLabel = options.SeleccionarLabel;
        this.SeleccionarIcon = options.SeleccionarIcon;
        this.SeleccionarClass = options.SeleccionarClass;
    ...
    FileInput.prototype = {
        ...
        renderMain: function () {
            ...
            return self.mainTemplate.replace('{class}', self.mainClass).
                ...
                replace('{Seleccionar}', self.renderSeleccionar());
        },
        renderSeleccionar: function () {
            var self = this, css = self.SeleccionarClass + ' btn-file', status = '';
            if (self.isDisabled) {
                status = ' disabled ';
            }
            return '<div class="' + css + '"' + status + '> ' + self.SeleccionarIcon + self.SeleccionarLabel + ' </div>';
        },
    ...
    $.fn.fileinput.defaults = {
        ...
        SeleccionarLabel: 'Seleccionar &hellip;',
        SeleccionarIcon: '<i class="glyphicon glyphicon-folder-open"></i> &nbsp;',
        SeleccionarClass: 'btn btn-primary',
        removeLabel: 'remove',
