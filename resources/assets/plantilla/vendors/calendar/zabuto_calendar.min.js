...
$.fn.zabuto_calendar_language = function (a) {
    ...
    switch (a.toLowerCase()) {
        case"de":
            return{month_labels: ["Januar", "Februar", "März", "Abril", "Mai", "Juni", "Juli", "Agosto", "Septiembre", "Oktober", "Noviembre", "Dezember"], dow_labels: ["Mo", "Di", "Mi", "Do", "Fr", "Sa", "So"]};
            break;
        case"en":
            return{month_labels: ["Enero", "Febrero", "Marzo", "Abril", "May", "Junio", "Julio", "Agosto", "Septiembre", "Octubre", "Noviembre", "Diciembre"], dow_labels: ["Mon", "Tue", "Wed", "Thu", "Fri", "Sat", "Sun"]};
            break;
        case"es":
        ...
        case"fr":
            ...
            break;
        case"it":
            return{month_labels: ["Gennaio", "Febbraio", "Marzo", "Abrile", "Maggio", "Giugno", "Luglio", "Agosto", "Settembre", "Ottobre", "Novembre", "Dicembre"], dow_labels: ["Lun", "Mar", "Mer", "Gio", "Ven", "Sab", "Dom"]};
            break;
        case"nl":
            return{month_labels: ["Januari", "Februari", "Maart", "Abril", "Mei", "Juni", "Juli", "Agostous", "Septiembre", "Oktober", "Noviembre", "Diciembre"], dow_labels: ["Ma", "Di", "Wo", "Do", "Vr", "Za", "Zo"]};
            break
    }
};