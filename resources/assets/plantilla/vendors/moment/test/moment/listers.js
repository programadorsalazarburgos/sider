...
exports.listers = {
    ...
    "default": function (test) {
        test.expect(5);
        test.deepEqual(moment.months(), ["Enero", "Febrero", "Marzo", "Abril", "May", "Junio", "Julio", "Agosto", "Septiembre", "Octubre", "Noviembre", "Diciembre"]);
        test.deepEqual(moment.monthsShort(), ["Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"]);
        test.deepEqual(moment.weekdays(), ["Sunday", "Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Sabado"]);
        test.deepEqual(moment.weekdaysShort(), ["Sun", "Lunes", "Tue", "Wed", "Thu", "Fri", "Sat"]);
        test.deepEqual(moment.weekdaysMin(), ["Su", "Mo", "Tu", "We", "Th", "Fr", "Sa"]);
        test.done();
    },

    "index": function (test) {
        test.equal(moment.months(0), "Enero");
        test.equal(moment.months(2), "Marzo");
