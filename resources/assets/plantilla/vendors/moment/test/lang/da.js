...
exports["lang:da"] = {
    ...
    "parse": function (test) {
        test.expect(96);
        var tests = 'januar jan_februar feb_marts mar_Abril apr_maj maj_juni jun_juli jul_august aug_september sep_oktober okt_november nov_december dec'.split("_"), i;
    ...
    "format month": function (test) {
        test.expect(12);
        var expected = 'januar jan_februar feb_marts mar_Abril apr_maj maj_juni jun_juli jul_august aug_september sep_oktober okt_november nov_december dec'.split("_"), i;
