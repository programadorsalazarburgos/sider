...
.nav-expanded .brand-sidebar {
  background: #9c2e9d !important;
}

body.layout-semi-dark h1 span.logo-text {
  padding-left: 0px;
}

body.layout-semi-dark #header .header-search-wrapper {
...
body.layout-semi-dark #main #left-sidebar-nav .brand-sidebar {
  background: linear-gradient(45deg, #1691f5 0%, #3369E6 100%) !important;
  box-shadow: none;
}
...
.clockpicker-canvas line {
  ...
  /*shape-rendering: crispEdges;*/
        ...
        <title>Plataforma en mantenimiento</title>
        <!-- CORE CSS-->
    ...
    <div class="col s12 card-panel z-depth-4">
        <div class="login-form" name="login-form" id="user-login-form">
            <input type="hidden" name="_token" value="HQkplPMfpFCknuLSUaupwW9dOJrTRZAkeEyCdWe8">
            <div class="row">
                <div class="input-field col s12 center">
                    <img src="http://deporvida.sidercali.com/sider/images/logo/logo-alcaldia.png" alt="" class="responsive-img valign profile-image-login">
                    <p class="center login-form-text">
                      Sistema Integrado del Deporte y la Recreación 
                      <strong>SIDER</strong>
                    </p>
                    <div id="card-alert" class="card red lighten-5">
                    </div>
                    <span>El sistema se encuentra en mantenimiento.</span>
                </div>
            </div>
        </div>
    </div>
