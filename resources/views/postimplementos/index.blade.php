<div ng-controller="ImplementosCrtl">
...
<div class="row">
    ...
    <div class="col-md-5">
    <h5>Resultado @{{ filtered.length }} de @{{ totalItems}} total Implementos</h5>
    </div>
</div>
<div class="clearfix"></div><br>
    ...
    <div id="tableactionTabContent" class="tab-content">
        ...
        <div class="row">
            ...
            <div class="table-container">
                <div class="row mbm">
                <div class="col-lg-6">
                    <div class="pagination-panel">Resultado @{{ filtered.length }} de @{{ totalItems}} total Implementos
                    </div>
                </div>
                </div>
                ...
                <div class="portlet-body">
                    <div class="actions">
                    <a ng-href="/admin/postimplementos#/admin/postimplementos/create" class="btn btn-info"><i class='fa fa-plus'></i> Nuevo</a>
                    </div>
                </div>
                ...
                <table id="example-export" class="table table-hover table-striped table-bordered table-advanced tablesorter" ng-init="getData()">
                    <thead>
                    <th>NOMBRE IMPLEMENTO&nbsp;<a ng-click="sort_by('customerName');"><i class="glyphicon glyphicon-sort"></i></a></th>
                    ...
                    <tr dir-paginate="data in list|orderBy:sortKey:reverse|filter:search|itemsPerPage: pageSize">
                        ...
                        <div class="btn-group pull-right">
                            ...
                            <li>
                                <a ng-href="/admin/postimplementos#/admin/postimplementos/editando/@{{data.id}}"><i class="fa fa-pencil-square-o"></i>&nbsp;Editar</a>
                            </li>
                            <li>
