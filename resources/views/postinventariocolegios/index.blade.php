<div ng-controller="InventarioColegioCtrl">
                ...
                <div class="table-container">
                  ...
                  <div class="table-responsive">
                    ...
                    <div class="portlet-body">
                      <div class="actions">
                        <a ng-href="/admin/postinventariocolegios#/admin/postinventariocolegios/create" class="btn btn-primary"><i class='fa fa-plus'></i> Inventario</a>
                      </div>
                    </div>
                        ...
                        <tr dir-paginate="data in list|orderBy:sortKey:reverse|filter:search|itemsPerPage: pageSize">
                          ...
                          <td>
                            <div class="btn-group pull-right">
                              <a class="btn btn-success" ng-click="ObtenerImplementos('obtener', data.id)"><i class="fas fa-baseball-ball"></i>&nbsp;Implementos</a>
                            </div>
                          </div>
                        </td>
                      </tr>
                      ...
                      <div class="portlet-body">
                        <div class="actions">  
                          ...
                          <table id="example-export" class="table table-hover table-striped table-bordered table-advanced tablesorter" ng-init="getData()">
                            ...
                            <tbody>
                              <tr dir-paginate="data in implementosedes|orderBy:sortKey:reverse|filter:search|itemsPerPage: pageSize">
                                  <td>@{{data.nombre_institucion | uppercase }}  </td>
                                  <td>@{{data.nombre_sede | uppercase }}  </td>
