...
<li class="active"><a href="#details" data-toggle="tab" aria-expanded="false">Formulario Creación Modalidad</a></li>
</ul>
...
<div class="col-sm-8">
    <input class="form-control" placeholder="Digita Nombre Modalidad" name="nombre" ng-model="nombre" required></input>
...
<div ng-repeat="car in cars">
 ...
 <button type="submit" class="btn btn-success" ng-click="formsubmit(frm.$valid)"  ng-disabled="frm.$invalid"><i class="fa fa-save"></i>&nbsp;&nbsp;Guardar Modalidad</button>
