...
<li class="active"><a href="#details" data-toggle="tab" aria-expanded="false">Formulario Creación Comuna</a></li>
</ul>
...
<div class="col-sm-8">
    <input class="form-control" placeholder="Digita Código Comuna" name="codigo_comuna" value="@{{codigo_comuna}}" ng-model="serie.codigo_comuna" required></input>
...
<div class="col-sm-8">
    <input class="form-control" placeholder="Digita Nombre Comuna" name="nombre_comuna" value="@{{nombre_comuna}}" ng-model="serie.nombre_comuna" required></input>
    <span class="label label-danger" ng-show="frm.nombre_comuna.$dirty && frm.nombre_comuna.$error.required">Requerido</span>
</div>
</div>

<div class="form-group">
<label for="note" class="col-sm-2 control-label">Zona</label>
 <div class="col-sm-6">
  <select class="form-control" name="zona" id="zona" required ng-change="unitChanged()" ng-model="data.unit" ng-options="unit.id as unit.nombre_zona for unit in zonas"></select>
...
<div ng-repeat="car in cars">
 ...
 <button type="submit" class="btn btn-success" ng-click="formsubmit(serie.id, frm.$valid)"  ng-disabled="frm.$invalid"><i class="fa fa-save"></i>&nbsp;&nbsp;Actualizar Comuna</button>
