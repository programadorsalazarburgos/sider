                    ...
                    <form class="form-horizontal" id="f1" name="frm" submit="submitForm()" novalidate>
                        <div class="nav-tabs-custom">
                            <ul class="nav nav-tabs">
                                <li class="active"><a href="#details" data-toggle="tab" aria-expanded="false">Formulario Editar Titulo</a></li>
                            </ul>
                            <div class="tab-content">
                                ...
                                <div class="tab-pane active" id="details">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input class="form-control" placeholder="Digita descripción titulo" name="descripcion" value="@{{descripcion}}" ng-model="serie.descripcion" required></input>
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-6">
                                            ...
                                            <button type="submit" class="btn btn-azul" ng-click="formsubmit(serie.id, frm.$valid)"  ng-disabled="frm.$invalid"><i class="fa fa-save"></i>&nbsp;&nbsp;Actualizar Titulo</button>
