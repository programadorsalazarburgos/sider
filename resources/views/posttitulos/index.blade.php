<div ng-controller="TitulosCrtl">
        ...
        <div class="row">
          ...
          <div class="col-md-5">
            <h5>Resultado @{{ filtered.length }} de @{{ totalItems}} total Titulos</h5>
          </div>
        </div>
        <div class="clearfix"></div><br>
                ...
                <div class="row">
                  <div class="col-lg-12"><h4 class="box-heading">Paginación</h4>
                    <div class="table-container">
                      <div class="row mbm">
                        <div class="col-lg-6">
                          <div class="pagination-panel">Resultado @{{ filtered.length }} de @{{ totalItems}} total Titulos
                          </div>
                        </div>
                      </div>
                      <div class="table-responsive">
                        ...
                        <div class="portlet-body">
                          <div class="actions">
                            <a ng-href="/admin/posttitulos#/admin/posttitulos/create" class="btn btn-info"><i class='fa fa-plus'></i> Nuevo</a>
                          </div>
                        </div>
                        ...
                        <table id="example-export" class="table table-hover table-striped table-bordered table-advanced tablesorter" ng-init="getData()">
                          <thead>
                            <th>NOMBRE TITULO&nbsp;<a ng-click="sort_by('customerName');"><i class="glyphicon glyphicon-sort"></i></a></th>
                              ...
                              <td>
                                <div class="btn-group pull-right">
                                  ...
                                  <ul class="dropdown-menu">
                                    <li>
                                      <a ng-href="/admin/posttitulos#/admin/posttitulos/editando/@{{data.id}}"><i class="fa fa-pencil-square-o"></i>&nbsp;Editar</a>
                                    </li>
                                    <li>
