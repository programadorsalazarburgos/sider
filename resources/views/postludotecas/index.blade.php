<div ng-controller="LudotecasCrtl">
    ...
    <div class="col-md-5">
    <h5>Resultado @{{ filtered.length }} de @{{ totalItems}} total Ludotecas</h5>
    </div>
    </div>
    ...
    <div class="col-lg-12"><h4 class="box-heading">Paginación</h4>
      ...
      <div class="table-container">
        <div class="row mbm">
          <div class="col-lg-6">
            <div class="pagination-panel">Resultado @{{ filtered.length }} de @{{ totalItems}} total Ludotecas
            </div>
          </div>
        ...
        <div class="table-responsive">
          ...
          <div class="portlet-body">
            <div class="actions">
              <a ng-href="/admin/postludotecas#/admin/postludotecas/create" class="btn btn-info"><i class='fa fa-plus'></i> Nuevo</a>
            </div>
          </div>
          ...
          <table id="example-export" class="table table-hover table-striped table-bordered table-advanced tablesorter" ng-init="getData()">
            ...
            <thead>
              ...
              <th>Nombre Ludoteca&nbsp;<a ng-click="sort_by('customerName');"><i class="glyphicon glyphicon-sort"></i></a></th>
            ...
            <tbody>
              <tr dir-paginate="data in list|orderBy:sortKey:reverse|filter:search|itemsPerPage: pageSize">
                ...
                <td>@{{data.nombre_ludoteca | uppercase }} </td>
                ...
                <td>
                  ...
                  <div class="btn-group pull-right">
                    ...
                    <ul class="dropdown-menu">
                      ...
                      <li>
                        <a ng-href="/admin/postludotecas#/admin/postludotecas/editando/@{{data.id}}"><i class="fa fa-pencil-square-o"></i>&nbsp;Editar</a>
                      </li>
