                    ...
                    <div class="panel">
                        ...
                        <div class="col-md-6" style="position: relative; left: 35px;">
                               <label class="control-label" style="position: relative; right:32px;" for="empleado-nivel_formacion">Titulo obtenido</label>
                                <select chosen class="form-control" name="titulo_obtenido" id="titulo_obtenido" ng-model="serie.titulo_obtenido" ng-options="titulo.id as titulo.descripcion for titulo in titulos">
                          ...
                          <div class="col-md-6" style="position: relative; left: 35px;">
                                <label style="position: relative; right:32px;" class="control-label" for="empleado-nivel_formacion">Institución educativa superior</label>
                                <select chosen class="form-control" name="tipo_univ" id="tipo_univ" ng-model="tipo_univ.universidad" ng-options="universidad.id as universidad.nombre for universidad in universidades">
