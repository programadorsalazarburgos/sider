                    ...
                    <div class="nav-tabs-custom">
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane active" id="details">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="input-group">
                                                <input class="form-control" placeholder="Digita Número de Documento" type="text" name="integer-data-attribute" data-thousands="." value="@{{documento}}" ng-model="serie.documento" required />
                                                <span class="input-group-btn">
                                                    <button onclick="change_documento()" class="btn btn-default" type="button"><i class="glyphicon glyphicon-search"></i></button>
                                                </span>
                                                <div ng-show="frm.$submitted || frm.serie.documento.$untouched">
                                                    <span class="label label-danger" ng-show="frm.serie.documento.$error.required">Dato Requerido.</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class='col-sm-6'>    
                                        <div class='form-group'>
                                            ...
                                            <input type="text" class="form-control" name="nombre_primero" value="@{{nombre_primero}}" ng-model="serie.nombre_primero"  placeholder="Primer Nombre" required uppercased>
                                ...
                                <div class="row">
                                    <div class='col-sm-6'>    
                                        <div class='form-group'>
                                            ...
                                            <input type="text" class="form-control" name="apellido_primero" value="@{{apellido_primero}}" ng-model="serie.apellido_primero" placeholder="Primer Apellido" required uppercased>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control" name="correo_electronico" required value="@{{correo_electronico}}" ng-model="serie.correo_electronico" placeholder="Correo Electronico" uppercased>
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <input class="form-control" type="text" name="fecha_nacimiento" id="fecha_nacimiento" value="@{{fecha_nacimiento}}" ng-model="serie.fecha_nacimiento" placeholder="año/mes/día" required>
                                        ...
                                        <div class="container-fluid">
                                            <div class="row">
                                                ...
                                                <div ng-show="ngShowhide2">
                                                    <div class="col-md-8">
                                                        <label class="control-label" for="empleado-id_ciudad">Departamento/Municipio</label>
                                ...
                                <div class="panel">
                                    <div class="panel-heading" style="position:relative: top:8px;">Datos de Residencia</div>
                                    <div class="panel-body">
                                        <div class="container-fluid">
                                            <div class="row">
                                                <div class="col-md-4">
                                            ...
                                            <div class="row" ng-show="direcc">
                                                ...
                                                <div class="clearfix"><br><br><br><br>
                                                    ...
                                                    <div class="col-md-4">
                                                        ...
                                                        <select class="form-control" name="tip_estrato" id="tip_estrato" required  ng-model="tipo_estrato.unit" ng-options="unit.id as unit.nombre for unit in estrato">
                                    ...
                                    <div class="row" ng-show="direcc">
                                        ...
                                        <div class="col-md-6" id="div_direccion" ng-show="ngShowhideDireccion">
                                            ...
                                            <input type="text" id="id_persona_beneficiario_residencia_direccion" class="form form-control" name="residencia_direccion" value="@{{residencia_direccion}}" ng-model="serie.residencia_direccion" style="background-color: #FFF;">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input class="form-control" numbers-only  required="true" size="30" type="text" placeholder="Telefono Movil" type="number" name="telefono_movil" value="@{{telefono_movil}}" ng-model="serie.telefono_movil"/>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <label class="control-label" for="empleado-nivel_formacion">Titulo obtenido</label>
                                            <select class="form-control" name="titulo_obtenido" id="titulo_obtenido" ng-model="serie.titulo_obtenido" ng-options="titulo.id as titulo.descripcion for titulo in titulos">
                                                <option value=''>Seleccione titulo obtenido</option>
                                            </select>
                                        </div>
                                        <div class="col-md-6">
                                            <label class="control-label" for="empleado-nivel_formacion">Institución educativa superior</label>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" type="number" class="form-control"  value="@{{cantidad_hijos}}" ng-model="serie.cantidad_hijos" numbers-only  placeholder="Cuantos Hijos?"  ng-disabled="isDisabled">
                                ...
                                <div class="row">
                                    <div class="container-fluid">
                                        ...
                                        <div class="col-md-6" id="div_enfermedad">
                                            ...
                                            <input type="text" class="form-control" value="@{{otra_enfermedad}}" ng-model="serie.otra_enfermedad" placeholder="Otra ¿Cuál?" ng-disabled="isDisabledDiscapacidad" uppercased>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="container-fluid">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input class="form-control" size="30" type="text" placeholder="¿Cuál(es)?" disabled ng-disabled="isDisabledMedicamento" value="@{{otros_medicamentos}}" ng-model="serie.otros_medicamentos" uppercased/>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <input value=""  type="text" value="@{{distrito_militar}}" ng-model="serie.distrito_militar" id="ficha_distrito_militar" class="form-control" uppercased>
                            </div>
                            <div class="col-md-6">
                                <label class="control-label" for="empleado-skype">Skype</label>
                                <input value=""  type="text"  value="@{{skype_empleado}}" ng-model="serie.skype_empleado" id="ficha_skype" class="form-control" maxlength="50" uppercased>
                            </div>
                            <div class="clearfix"></div><br>
                            <div class="col-md-12">
                                <label class="control-label" for="empleado-proyecto_profesional">Proyecto profesional</label>
                                <textarea id="ficha_proyecto_profesional" value="@{{proyecto_profesional}}" ng-model="serie.proyecto_profesional" class="form-control"  rows="6" uppercased style="height:76px;"></textarea>
                            </div>
                            <div class="clearfix"></div><br>
                            <legend>Datos Disciplina (Opcional)</legend>
                            <div class='row'>
                                <div class="col-md-12">
                                    <div class='form-group'> 
                            ...
                            <hr />  
                            <div class="col-md-6">
                                <label class="control-label" for="empleado-libreta_militar">Rol</label>
                                <select class="form-control" name="rol" id="rol" required ng-change="unitChanged()" ng-model="data.unit" ng-options="unit.id as unit.name for unit in roles"></select>
                                <div ng-show="frm.$submitted || frm.rol.$untouched">
                                    <span class="label label-danger" ng-show="frm.rol.$error.required">Dato Requerido.</span>
                                </div>
                            </div>      
                            <div class="clearfix"></div><br>
                            ...
                            <div class="form-group">
                                <div class="col-sm-6">
                                    ...
                                    <a href="{{url('/admin/postusuarios')}}" type="submit" class="btn btn-orange"><i class="fa fa-reply-all"></i>&nbsp;&nbsp;Atras</a>  
                                </div>
                            </div>
                            <hr>
                        </div>
