        ...
        <fieldset class="data_hide">
            ...
            <div class="row">
                ...
                <label class="col-md-3" style="text-transform: uppercase">
                    <input type="checkbox" id="id_grupo_poblacional_{{$temp->id_grupo_poblacional}}" name="grupo_poblacional[]" value="{{$temp->id_grupo_poblacional}}">{{$temp->descripcion}}<br>
                </label>
                @endforeach
                <div class="col-md-3">
