...
<div class="portlet-body">
   <div class="actions">
       <a ng-href="/admin/postescenarios#/admin/postescenarios/create" class="btn btn-info"><i class='fa fa-plus'></i> Nuevo</a>
   </div>
</div>
      ...
      <div class="btn-group pull-right">
         <button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown" aria-expanded="false">Acciones <span class="fa fa-caret-down"></span></button>
             <ul class="dropdown-menu">
                 ...
                 <li>
                    <a ng-href="/admin/postescenarios#/admin/postescenarios/editando/@{{data.id}}"><i class="fa fa-pencil-square-o"></i>&nbsp;Editar</a>
                 </li>
