                ...
                <div class="tab-pane active" id="details">
                  ...
                  <div class='row'>
                    <div class='col-sm-6'>
                      <div class='form-group'>
                        ...
                        <input class="form-control" placeholder="Digita Número de Documento" type="text" name="integer-data-attribute" data-thousands="."  value="@{{documento_acudiente}}" ng-blur="onBlurDocumentoAcudiente($event)" ng-model="acudiente.documento_acudiente" required="true" />
                    ...
                    <div class='col-sm-6'>
                      <div class='form-group'>
                        ...
                        <div ng-show="frm.$submitted || frm.tipo_dcac.$touched">
                  ...
                  <div class='row'>
                    <div class='col-sm-6'>    
                      <div class='form-group'>
                        ...
                        <div ng-show="frm.$submitted || frm.primer_nombre_acudiente.$touched">
                  ...
                  <div class='row'>
                    <div class='col-sm-6'>    
                      <div class='form-group'>
                        <label for="user_firstname">Primer Apellido</label>
                        <input type="text" class="form-control" name="primer_apellido_acudiente"  value="@{{apellido_primero_acudiente}}" ng-model="acudiente.apellido_primero_acudiente"  placeholder="Primer Apellido" uppercased>
                      </div>
                    </div>
                    <div class='col-sm-6'>
                      <div class='form-group'>
                  ...
                  <div class='row'>
                    <div class='col-sm-6'>
                      <div class='form-group'>
                        ...
                        <select class="form-control" name="genero_acudiente" id="genero_acudiente" required  ng-model="tipo_sex_acudiente.unit" ng-options="unit.id as unit.nombre for unit in sexo" style="width: 280px; position: relative; top: 6px;">
                          <option value=''>Seleccione sexo</option>
                        </select>
                        <div ng-show="frm.$submitted || frm.genero_acudiente.$touched">
                    ...
                    <div class='col-sm-6'>
                      <div class='form-group'>
                        ...
                        <input class="form-control" type="text" name="fecha_nac_acudiente" id="fecha_nacimiento_acudiente" value="@{{fecha_nacimiento_acudiente}}" ng-model="acudiente.fecha_nacimiento_acudiente" placeholder="año/mes/día">
                        <div ng-show="frm.$submitted || frm.fecha_nac_acudiente.$touched">
                  ...
                  <div class='row'>
                    ...
                    <div class='col-sm-4'>
                      <div class='form-group'>
                        ...
                        <div ng-show="frm.$submitted || frm.telefono_movil_acudiente.$touched">
                  ...
                  <div class='row'>
                    <div class='col-sm-6'>
                      <div class='form-group'>
                        ...
                        <select class="form-control" name="tipo_parent_ac" id="tipo_parent_ac" required  ng-model="tipo_parent" ng-options="unit.id as unit.nombre for unit in parentescos" style="width: 280px; position: relative; top: 0px;" ng-change='selectedParentesco(tipo_parent.unit)'>
                          <option value=''>Seleccione parentesco</option>
                        </select>
                        <div ng-show="frm.$submitted || frm.tipo_parent_ac.$touched">
