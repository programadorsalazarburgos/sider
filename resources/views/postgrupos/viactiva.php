                ...
                <div class="tab-pane active" id="details">
                  ...
                  <div class='col-sm-6'>
                    <div class='form-group'>
                      ...
                      <input class="form-control" type="text" id="fecha_inscripcion" value="@{{ficha.fecha_inscripcion}}" ng-model="fecha_inscripcion" placeholder="año/mes/día">
                    </div>
                  </div>
                  </div>
                  <div class="row">
                  ...
                  <div class="col-md-4">
                    ...
                    <select class="form-control" style="position:relative; top:16px;" name="tipo_salud_otra" id="tipo_salud_otra"  ng-model="tipo_salud_otra" ng-options="tipo_salud_otra.id as tipo_salud_otra.descripcion for tipo_salud_otra in salud_sgsss"   ng-disabled="isDisabledSeguridad">
                      <option value=''>Seleccione</option>
                    </select>
                  </div>
                  <div class="clearfix"></div><br>
                  ...
                  <div class='row'>
                    <div class='col-sm-6'>
                      <div class='form-group'>
                        ...
                        <select class="form-control" name="tipo_sex_acudiente" id="tipo_sex_acudiente" ng-model="tipo_sex_acudiente" ng-options="tipo_sex_acudiente.id as tipo_sex_acudiente.nombre for tipo_sex_acudiente in sexo" style="width: 280px; position: relative; top: 0px;">
                          <option value=''>Seleccione sexo</option>
                        </select>
