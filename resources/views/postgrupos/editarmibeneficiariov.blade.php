            ...
            <div class="nav-tabs-custom">
              <ul class="nav nav-tabs">
                <li class="active"><a href="#details" data-toggle="tab" aria-expanded="false">
                  ...
                  BENEFICIARIOS 1,2,3,6,7,8 -></span>
                </a></li>
              </ul>
              <div class="tab-content">
                ...
                <div class="tab-pane active" id="details">
				  ...
				  <div class="col-md-6">
                    ...
                    <input class="form-control" type="text" name="fecha_nac"  id="fecha_nacimiento" value="@{{fecha_nacimiento}}" ng-model="serie.fecha_nacimiento" placeholder="año/mes/día">
                  
                  </div>
                  <div class="col-md-4">
                    <label class="control-label" for="empleado-sexo">Sexo</label>
                    <select class="form-control" name="tipo_genero" id="tipo_genero"  ng-model="tipo_sex.unit" ng-options="unit.id as unit.nombre for unit in sexo">
				...
				<!-- END ROW -->
                  ...
                  <div class="panel">
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        ...
                        <select class="form-control" name="nivel_escolaridad" id="nivel_escolaridad"  ng-model="tipo_esc" ng-options="unit.id as unit.descripcion for unit in escolaridades">
                      ...
                      <div class="col-md-6">
                        ...
                        <select class="form-control" name="estado_esc" id="estado_esc"  ng-model="estado_esc" ng-options="unit.id as unit.descripcion for unit in estadoescolaridades">
                          <option value=''>Seleccione</option>
                        </select>
                  ...
                  <div class='row'>
                    <div class='col-sm-6'>
                      <div class='form-group'>
                        ...
                        <input class="form-control" placeholder="Digita Número de Documento" type="text" name="integer-data-attribute" data-thousands="."  value="@{{documento_acudiente}}" ng-blur="onBlurDocumentoAcudiente($event)" ng-model="acudiente.documento_acudiente" />
                    ...
                    <div class='col-sm-6'>
                      <div class='form-group'>
                        ...
                        <select class="form-control" name="tipo_dcac" id="tipo_dcac"  ng-model="tipo_doc_acudiente" ng-options="unit.id as unit.descripcion for unit in tipodocumento">
                          <option value=''>Seleccione tipo documento</option>
                        </select>
                  ...
                  <div class='row'>
                    <div class='col-sm-6'>    
                      <div class='form-group'>
                        <label for="user_firstname">Primer Nombre</label>
                        <input type="text" class="form-control" name="primer_nombre_acudiente" value="@{{nombre_primero_acudiente}}" ng-model="acudiente.nombre_primero_acudiente" placeholder="Primer Nombre" uppercased>
                  ...
                  <div class='row'>
                    <div class='col-sm-4'>
                      <div class='form-group'>
                        ...
                        <select class="form-control" name="genero_acudiente" id="genero_acudiente"  ng-model="tipo_sex_acudiente" ng-options="unit.id as unit.nombre for unit in sexo" style="width: 280px; position: relative; top: 6px;" ng-change='selectedSexAcudiente(tipo_sex_acudiente)'>
                          <option value=''>Seleccione sexo</option>
                        </select>
                      </div>
                    </div>
					<div class='col-sm-2'>
						<div class='form-group' ng-show="ngShowhideOtroSexoAcudiente">
							<label for="sexo_acudiente_otro">-</label>
                  ...
                  <div class='row'>
                    ...
                    <div class='col-sm-4'>
                      <div class='form-group'>
                        ...
                        <input type="text" numbers-only  class="form-control" name="telefono_movil_acudiente" value="@{{telefono_movil_acudiente}}" ng-model="acudiente.telefono_movil_acudiente"  placeholder="Telefono Movil">
