                ...
                <div class="tab-pane active" id="details">
                  ...
                  <div class='col-sm-6'>
                    <div class='form-group'>
                      ...
                      <input type="text" class="form-control" value="@{{no_ficha}}" name="no_ficha" ng-model="ficha.no_ficha"  placeholder="No Ficha">
                    </div>
                  </div>
                  <div class='col-sm-6'>
                    <div class='form-group'>
                  ...
                  <div class='row'>
                    ...
                    <div class='col-sm-6'>
                      <div class='form-group'>
                        ...
                        <input class="form-control" placeholder="Digita Número de Documento"  type="text" name="documento_acudiente" data-thousands="."  value="@{{documento_acudiente}}" ng-blur="onBlurDocumentoAcudiente($event)" ng-model="documento_acudiente" />
                  ...
                  <div class='row'>
                    <div class='col-sm-4'>
                      <div class='form-group'>
                        ...
                        <select class="form-control" name="genero_acudiente" id="genero_acudiente"   ng-model="tipo_sex_acudiente.unit" ng-options="unit.id as unit.nombre for unit in sexo" style="width: 280px; position: relative; top: 0px;" ng-change='selectedSexAcudiente(tipo_sex_acudiente)'>
                          <option value=''>Seleccione sexo</option>
                        </select>
                    ...
                    <div class='col-sm-6'>
                      <div class='form-group'>
                        ...
                        <input class="form-control" type="text" id="fecha_nacimiento_acudiente"  name="fecha_nac_acudiente" value="@{{fecha_nacimiento_acudiente}}" ng-model="fecha_nacimiento_acudiente" placeholder="año/mes/día">
                  ...
                  <div class='row'>
                    <div class='col-sm-6'>
                      <div class='form-group'>
                        ...
                        <select class="form-control" name="tipo_parent_ac" id="tipo_parent_ac"   ng-model="tipo_parent" ng-options="unit.id as unit.nombre for unit in parentescos" style="width: 280px; position: relative; top: 0px;" ng-change='selectedParentesco(tipo_parent)'>
