            ...
            <div class="nav-tabs-custom">
              ...
              <div class="tab-content">
                ...
                <div class="tab-pane active" id="details">
                  ...
                  <div class='col-sm-6'>
                    <div class='form-group'>
                      <label for="user_firstname">Fecha Inscripcióne</label>
				  ...
				  <div class="row">
					  ...
					  <div class="col-md-6">
						...
						<input class="form-control" type="text" name="fecha_nac" id="fecha_nacimiento" value="@{{fecha_nacimiento}}" ng-model="persona.fecha_nacimiento" placeholder="año/mes/día">
					  </div>
				  </div>
				  <!-- END ROW -->
				  <div class="row">
                  ...
                  <div class="panel">
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        ...
                        <select class="form-control" name="tipo_esc" id="tipo_esc"  ng-model="tipo_esc" ng-options="tipo_esc.id as tipo_esc.descripcion for tipo_esc in escolaridades">
                      ...
                      <div class="col-md-6">
                        ...
                        <select class="form-control" name="estado_esc" id="estado_esc"  ng-model="estado_esc" ng-options="estado_esc.id as estado_esc.descripcion for estado_esc in estadoescolaridades">
                          <option value=''>Seleccione</option>
                        </select>
