        ...
        <div class="table-container">
          ...
          <div class="table-responsive">
                ...
                <tr dir-paginate="data in list|orderBy:sortKey:reverse|filter:search|itemsPerPage: pageSize">
                  ...
                  <td>        
                    <div style="text-align: center;">
                      <a ng-href="/admin/postgrupos#/admin/postgrupos/infoasistencias/@{{data.id}}/grupo/@{{data.grupo_beneficiario}}" class="btn btn-primary">Información Asistencias </a>
                    </div>
                  </td>
                  <td>
                    <div ng-if="data.estado == '0'">                
                      <div class="btn-group pull-right">
                        ...
                        <ul class="dropdown-menu">
                          <li>
                            <a ng-href="/admin/postgrupos#/admin/postgrupos/editando/mibeneficiario/@{{data.id}}"><i class="fa fa-pencil-square-o"></i>&nbsp;Editar</a>
                          </li>
                          <li>
            ...
            <div class="col-md-12" ng-show="filteredItems == 0">
             ...
             <div class="col-md-12" ng-show="filteredItems > 0" style="padding: 50px;">
