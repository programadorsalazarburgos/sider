<div ng-controller="MisBeneficiariosGrupoConsultaCtrl">
            ...
            <tbody>
                ...
                <td>        
                  <div style="text-align: center;">
                    <a ng-href="/admin/postgrupos#/admin/postgrupos/infoasistencias/@{{data.id}}/grupo/@{{data.grupo_beneficiario}}" class="btn btn-primary">Info Fechas Asistencias </a>
                  </div>
                </td>
              </tr>
            </tbody>
