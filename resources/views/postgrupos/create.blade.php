              ...
              <div class="tab-content">
                ...
                <div class="tab-pane active" id="details">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-6">
                      <select name="tip_sangre" ng-model="grado" class="form-control" required>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-8">
                      <textarea class="form-control" placeholder="Digita Observaciones" name="observaciones" ng-model="observaciones"></textarea>
