<div ng-controller="DisciplinasCrtl">
  ...
  <div class="row">
    ...
    <div class="col-md-5">
      <h5>Resultado @{{ filtered.length }} de @{{ totalItems}} total Disciplinas</h5>
    </div>
  </div>
  <div class="clearfix"></div><br>
          ...
          <div class="row">
            <div class="col-lg-12"><h4 class="box-heading">Paginación</h4>
              <div class="table-container">
                <div class="row mbm">
                  <div class="col-lg-6">
                    <div class="pagination-panel">Resultado @{{ filtered.length }} de @{{ totalItems}} total Disciplinas
                    </div>
                  </div>
                </div>
                <div class="table-responsive">
                  <div class="portlet-body">
                    <div class="actions">
                      <a ng-href="/admin/postdisciplinas#/admin/postdisciplinas/create" class="btn btn-info"><i class='fa fa-plus'></i> Nuevo</a>
                    </div>
                  </div>
                        ...
                        <td>                                     
                          <div class="btn-group pull-right">
                            ...
                            <ul class="dropdown-menu">
                              <li>
                                <a ng-href="/admin/postdisciplinas#/admin/postdisciplinas/editando/@{{data.id}}"><i class="fa fa-pencil-square-o"></i>&nbsp;Editar</a>
                              </li>
