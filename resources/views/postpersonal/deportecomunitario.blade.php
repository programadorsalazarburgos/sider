              ...
              <div class="nav-tabs-custom">
                ...
                <div class="tab-content">
                  ...
                  <div class="tab-pane active" id="details">
                    <div class="col-lg-12">
                      <h5 class="box-heading" align="center" style="font-size: 18px;">REGISTRO DE USUARIOS: <span class="label label-warning" style="font-size: 15px;">PROGRAMA-DEPORTE COMUNITARIO</span></h5>
                    </div>
                    <div class="clearfix"></div>
                    <br>
                    <fieldset>
