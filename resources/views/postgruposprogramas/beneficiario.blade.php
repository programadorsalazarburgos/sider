                ...
                <div class="tab-pane active" id="details">
                  ...
                  <fieldset>
                    ...
                    <div class="col-md-6">
                      ...
                      <div ng-show="frm.$submitted || frm.tipo_documento.$untouched">
                    ...
                    <div class="col-md-6">
                      ...
                      <div class="input-group">
                        ...
                        <span class="input-group-btn">
                          <button onclick="change_documento()" class="btn btn-default" type="button" style="position:  relative;top:  -9px;"><i class="glyphicon glyphicon-search"></i></button>
                        </span>
                      </div>
                    </div>
                    </div>
                  ...
                  <div class='col-sm-6'>
                    <div class='form-group'>
                      ...
                      <input type="text" class="form-control" value="@{{no_ficha}}" name="no_ficha" ng-model="ficha.no_ficha"  placeholder="No Ficha" required>
                      <div ng-show="frm.$submitted || frm.no_ficha.$untouched">
                          <span class="label label-danger" ng-show="frm.no_ficha.$error.required">Dato Requerido.</span>
                      </div>
                    </div>
                  </div>
                  <div class='col-sm-6'>
                    <div class='form-group'>
                      ...
                      <input class="form-control" type="text" id="fecha_inscripcion" value="@{{fecha_inscripcion}}" ng-model="ficha.fecha_inscripcion" placeholder="año/mes/día">
                    </div>
                  </div>
                  </div>
                  <div class="row">
                  ...
                  <div class="col-md-6">
                    ...
                    <input type="text" class="form-control" value="@{{correo_electronico}}" ng-model="persona.correo_electronico" placeholder="Correo Electronico" uppercased>
                  </div>
                  <div class="col-md-3">
                  ...
                  <div class="panel">
                        ...
                        <div ng-show="ngShowhide1">
                          ...
                          <div class="clearfix"><br><br><br><br>
                            ...
                            <div class="col-md-4">
                              ...
                              <select class="form-control" name="tipo_sx" id="tipo_sx" ng-model="tipo_estrato.unit" ng-options="unit.id as unit.nombre for unit in estrato">
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        ...
                        <div ng-show="frm.$submitted || frm.nivel_escolaridad.$untouched">
                    ...
                    <div class="col-md-6">
                      ...
                      <input type="text" type="number" class="form-control"  value="@{{cantidad_hijos_beneficiario}}" ng-model="ficha.cantidad_hijos_beneficiario" numbers-only  placeholder="Cuantos Hijos?"  ng-disabled="isDisabled">
                    </div>
                    <div class="col-md-6">
                    ...
                    <div class="row">
                      <div class="container-fluid">
                        ...
                        <div class="col-md-6" id="div_enfermedad">
                          ...
                          <input type="text" class="form-control" value="@{{otra_discapacidad_beneficiario}}" ng-model="ficha.otra_discapacidad_beneficiario" placeholder="Otra ¿Cuál?" ng-disabled="isDisabledDiscapacidad" uppercased>
                        </div>
                      </div>
                    </div>
                    <div class="clearfix"></div><br>
                    <div class="row">
                      <div class="container-fluid">
                        ...
                        <div class="col-md-6">
                          ...
                          <input class="form-control" size="30" type="text" placeholder="¿Cuál(es)?" disabled ng-disabled="isDisabledMedicamento" value="@{{medicamentos_beneficiario}}" ng-model="ficha.medicamentos_beneficiario" uppercased/>
                        </div>
                      </div>
                    </div>
                    <div class="clearfix"></div><br>
                  ...
                  <div class='row'>
                    <div class='col-sm-6'>
                      <div class='form-group'>
                        ...
                        <select class="form-control" name="tipo_dcac" id="tipo_dcac" required ng-model="tipo_doc_acudiente.unit" ng-options="unit.id as unit.descripcion for unit in tipodocumento">
                          <option value=''>Seleccione tipo documento</option>
                        </select>
                        <div ng-show="frm.$submitted || frm.tipo_dcac.$untouched">
                            <span class="label label-danger" ng-show="frm.tipo_dcac.$error.required">Dato Requerido.</span>
                        </div>
                      </div>
                    </div>
                    <div class='col-sm-6'>
                      <div class='form-group'>
                        ...
                        <input class="form-control" placeholder="Digita Número de Documento" required type="text" name="documento_acudiente" data-thousands="."  value="@{{documento_acudiente}}" ng-blur="onBlurDocumentoAcudiente($event)" ng-model="acudiente.documento_acudiente" />
                        <div ng-show="frm.$submitted || frm.documento_acudiente.$untouched">
                            <span class="label label-danger" ng-show="frm.documento_acudiente.$error.required">Dato Requerido.</span>
                        </div>
                      </div>
                    </div>
                  </div>
                  <div class='row'>
                    <div class='col-sm-6'>    
                      <div class='form-group'>
                        <label for="user_firstname">Primer Nombre</label>
                        <input type="text" class="form-control" name="primer_nombre_acudiente" required value="@{{nombre_primero_acudiente}}" ng-model="acudiente.nombre_primero_acudiente" placeholder="Primer Nombre" uppercased>
                        <div ng-show="frm.$submitted || frm.primer_nombre_acudiente.$untouched">
                            <span class="label label-danger" ng-show="frm.primer_nombre_acudiente.$error.required">Dato Requerido.</span>
                        </div>
                      </div>
                    </div>
                    <div class='col-sm-6'>
                      <div class='form-group'>
                        <label for="user_firstname">Segundo Nombre</label>
                        <input type="text" class="form-control" value="@{{nombre_segundo_acudiente}}" ng-model="acudiente.nombre_segundo_acudiente" placeholder="Segundo Nombre" uppercased>
                      </div>
                    </div>
                  </div>
                  <div class='row'>
                    <div class='col-sm-6'>    
                      <div class='form-group'>
                        <label for="user_firstname">Primer Apellido</label>
                        <input type="text" class="form-control" required name="primer_apellido_acudiente" value="@{{apellido_primero_acudiente}}" ng-model="acudiente.apellido_primero_acudiente"  placeholder="Primer Apellido" uppercased>
                        <div ng-show="frm.$submitted || frm.primer_apellido_acudiente.$untouched">
                            <span class="label label-danger" ng-show="frm.primer_apellido_acudiente.$error.required">Dato Requerido.</span>
                        </div>
                      </div>
                    </div>
                    <div class='col-sm-6'>
                      <div class='form-group'>
                        <label for="user_firstname">Segundo Apellido</label>
                        <input type="text" class="form-control" value="@{{apellido_segundo_acudiente}}" ng-model="acudiente.apellido_segundo_acudiente"  placeholder="Segundo Apellido" uppercased>
                      </div>
                    </div>
                  </div>
                  <div class='row'>
                    <div class='col-sm-6'>
                      <div class='form-group'>
                        ...
                        <select class="form-control" name="genero_acudiente" id="genero_acudiente" required  ng-model="tipo_sex_acudiente.unit" ng-options="unit.id as unit.nombre for unit in sexo" style="width: 280px; position: relative; top: 0px;">
                          <option value=''>Seleccione sexo</option>
                        </select>
                        <div ng-show="frm.$submitted || frm.genero_acudiente.$untouched">
                            <span class="label label-danger" ng-show="frm.genero_acudiente.$error.required">Dato Requerido.</span>
                        </div>
                      </div>
                    </div>
                    <div class='col-sm-6'>
                      <div class='form-group'>
                        ...
                        <input class="form-control" type="text" id="fecha_nacimiento_acudiente" required name="fecha_nac_acudiente" value="@{{fecha_nacimiento_acudiente}}" ng-model="acudiente.fecha_nacimiento_acudiente" placeholder="año/mes/día">
                        <div ng-show="frm.$submitted || frm.fecha_nac_acudiente.$untouched">
                            <span class="label label-danger" ng-show="frm.fecha_nac_acudiente.$error.required">Dato Requerido.</span>
                        </div>
                      </div>
                    </div>
                  </div>
                  <div class='row'>
                    <div class='col-sm-4'>
                      <div class='form-group'>
                        ...
                        <input type="text" class="form-control"  value="@{{telefono_fijo_acudiente}}" ng-model="acudiente.telefono_fijo_acudiente" only-number placeholder="Telefono Fijo">
                      </div>
                    </div>
                    <div class='col-sm-4'>
                      <div class='form-group'>
                        <label for="user_firstname">Telefono Movil</label>
                        <input type="text" numbers-only  class="form-control" name="telefono_movil_acudiente"  value="@{{telefono_movil_acudiente}}" ng-model="acudiente.telefono_movil_acudiente"  placeholder="Telefono Movil" required>
                        <div ng-show="frm.$submitted || frm.telefono_movil_acudiente.$untouched">
                            <span class="label label-danger" ng-show="frm.telefono_movil_acudiente.$error.required">Dato Requerido.</span>
                        </div>
                      </div>
                    </div>
                    <div class='col-sm-4'>
                      <div class='form-group'>
                        ...
                        <input type="text" class="form-control" value="@{{correo_electronico_acudiente}}" ng-model="acudiente.correo_electronico_acudiente" placeholder="Correo Electronico" uppercased>
                      </div>
                    </div>
                  </div>
                  <div class='row'>
                    <div class='col-sm-6'>
                      <div class='form-group'>
                        ...
                        <select class="form-control" name="tipo_parent_ac" id="tipo_parent_ac" required  ng-model="tipo_parent.unit" ng-options="unit.id as unit.nombre for unit in parentescos" style="width: 280px; position: relative; top: 0px;" ng-change='selectedParentesco(tipo_parent.unit)'>
                          <option value=''>Seleccione parentesco</option>
                        </select>
                        <div ng-show="frm.$submitted || frm.tipo_parent_ac.$untouched">
                            <span class="label label-danger" ng-show="frm.tipo_parent_ac.$error.required">Dato Requerido.</span>
                        </div>
                      </div>
                    </div>
                    <div class='col-sm-6'>
                      <div class='form-group'>
                        ...
                        <input class="form-control" value="@{{otro_parentesco_acudiente}}" ng-model="ficha.otro_parentesco_acudiente" size="30" type="text" placeholder="¿Cuál?" ng-disabled="isDisabledParentesco" uppercased/>
                      </div>
                    </div>
                  </div>
