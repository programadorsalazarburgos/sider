              ...
              <div class="tab-content">
                ...
                <div class="tab-pane active" id="details">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-6">
                      <input class="form-control" placeholder="Digita Nombre Grupo" name="nombre_grupo" value="@{{nombre_grupo}}" ng-model="serie.nombre_grupo" required></input>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-6">
                      <select class="form-control" name="tipo_univ" id="tipo_univ" ng-model="lugar" ng-options="lugar.id as lugar.nombre_lugar for lugar in lugares" required>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-6">
                      <select class="form-control" name="tipo_univ" id="tipo_univ" ng-model="disciplina" ng-options="disciplina.id as disciplina.nombre_disciplina for disciplina in disciplinas" required>
