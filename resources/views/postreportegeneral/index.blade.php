<div ng-controller="BeneficiariosReporteCrtl">
...
var headers = {
      codigo_grupo: 'codigo_grupo', // remove commas to avoid errors
  ...
  data.forEach((item) => {
      itemsFormatted.push({
          ...
          residencia_direccion: item.residencia_direccion,
          ...
          hijos_beneficiario: item.hijos_beneficiario,
          cantidad_hijos_beneficiario: item.cantidad_hijos_beneficiario,
          etnia_beneficiario: item.etnia_beneficiario,
          grupo_poblacional: item.grupo_poblacional,
          ...
          tipo_documento_acudiente: item.tipo_documento_acudiente,
          documento_acudiente: item.documento_acudiente,
          primer_nombre_acudiente: item.primer_nombre_acudiente,
          segundo_nombre_acudiente: item.segundo_nombre_acudiente,
          primer_apellido_acudiente: item.primer_apellido_acudiente,
          segundo_apellido_acudiente: item.segundo_apellido_acudiente,
          sexo_acudiente: item.sexo_acudiente,
          fecha_nacimiento_acudiente: item.fecha_nacimiento_acudiente,
          telefono_fijo_acudiente: item.telefono_fijo_acudiente,
          telefono_movil_acudiente: item.telefono_movil_acudiente,
          correo_acudiente: item.correo_acudiente,
          parentesco_acudiente: item.parentesco_acudiente,
          otro_parentesco_acudiente: item.otro_parentesco_acudiente,
          primer_nombre_usuario: item.primer_nombre_usuario,
          primer_apellido_usuario: item.primer_apellido_usuario
      });
  });
      ...
      <div id="table-table-tab" class="tab-pane fade in active">
        <div class="row">
          <div class="col-lg-12"><h4 class="box-heading" style="text-align:center;">Reporte General Beneficiarios</h4>
           ...
           <!--    <form class="form-vertical" role="form" method="get" enctype="multipart/form-data" action="{{url('export/reportgeneral')}}"> -->
                ...
                <table id="example-export" class="table table-hover table-striped table-bordered table-advanced tablesorter" ng-init="getData()">
                  ...
                  <tbody>
                    <tr dir-paginate="data in list|orderBy:sortKey:reverse|filter:search|itemsPerPage: pageSize">
                      ...
                      <td>@{{data.grupo_poblacional | uppercase }} </td>
