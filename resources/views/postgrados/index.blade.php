<div ng-controller="GradosCrtl">
  ...
  <div class="col-md-3">Busqueda:
        ...
        <div class="col-md-4">
            <h5>Resultado @{{ filtered.length }} de @{{ totalItems}} total Grados</h5>
        </div>
  </div>
...
<div class="table-container">
  <div class="row mbm">
    <div class="col-lg-6">
     <div class="pagination-panel">Resultado @{{ filtered.length }} de @{{ totalItems}} total Grados
     </div>
   </div>
...
<div class="portlet-body">
   <div class="actions">
       <a ng-href="/admin/postgrados#/admin/postgrados/create" class="btn btn-info"><i class='fa fa-plus'></i> Nuevo</a>
   </div>
</div>
 ...
 <div class="clearfix"></div>
    <br>
      <table id="example-export" class="table table-hover table-striped table-bordered table-advanced tablesorter" ng-init="getData()">
            ...
            <th>Nombre Grado&nbsp;<a ng-click="sort_by('customerName');"><i class="glyphicon glyphicon-sort"></i></a></th>
      ...
      <div class="btn-group pull-right">
         <button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown" aria-expanded="false">Acciones <span class="fa fa-caret-down"></span></button>
             <ul class="dropdown-menu">
                 ...
                 <li>
                    <a ng-href="/admin/postgrados#/admin/postgrados/editando/@{{data.id}}"><i class="fa fa-pencil-square-o"></i>&nbsp;Editar</a>
                 </li>
