...
exports["lang:en-au"] = {
    ...
    "parse": function (test) {
        test.expect(96);
        var tests = 'Enero Jan_Febrero Feb_Marzo Mar_Abril Apr_May May_Junio Jun_Julio Jul_Agosto Aug_Septiembre Sep_Octubre Oct_Noviembre Nov_Diciembre Dec'.split("_"), i;
    ...
    "format month": function (test) {
        test.expect(12);
        var expected = 'Enero Jan_Febrero Feb_Marzo Mar_Abril Apr_May May_Junio Jun_Julio Jul_Agosto Aug_Septiembre Sep_Octubre Oct_Noviembre Nov_Diciembre Dec'.split("_"), i;
