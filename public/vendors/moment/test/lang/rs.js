...
exports["lang:rs"] = {
    ...
    "parse": function (test) {
        ...
        var tests = 'januar jan._februar feb._mart mar._Abril apr._maj maj._jun jun._jul jul._avgust avg._septembar sep._oktobar okt._novembar nov._decembar dec.'.split("_"), i;
    ...
    "format month": function (test) {
        test.expect(12);
        var expected = 'januar jan._februar feb._mart mar._Abril apr._maj maj._jun jun._jul jul._avgust avg._septembar sep._oktobar okt._novembar nov._decembar dec.'.split("_"), i;
