...
exports["lang:sl"] = {
    ...
    "parse": function (test) {
        ...
        var tests = 'januar jan._februar feb._marec mar._Abril apr._maj maj_junij jun._julij jul._avgust avg._september sep._oktober okt._november nov._december dec.'.split("_"), i;
    ...
    "format month": function (test) {
        test.expect(12);
        var expected = 'januar jan._februar feb._marec mar._Abril apr._maj maj._junij jun._julij jul._avgust avg._september sep._oktober okt._november nov._december dec.'.split("_"), i;
