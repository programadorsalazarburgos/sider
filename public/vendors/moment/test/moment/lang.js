...
exports.lang = {
    ...
    "library ensure inheritance": function (test) {
        ...
        moment.lang('made-up', {
            ...
            months: "Febrero_Marzo_Abril_May_Junio_Julio_Agosto_Septiembre_Octubre_Noviembre_Diciembre_Enero".split("_")
            // the rest of the properties should be inherited.
        });

        test.equal(moment([2012, 5, 6]).format('MMMM'), 'Julio', 'Override some of the configs');
    ...
    "library langData": function (test) {
        ...
        test.equal(moment.langData().months(jan), 'Enero', 'no arguments returns global');
    ...
    "instance lang method": function (test) {
        ...
        test.equal(moment([2012, 5, 6]).format('MMMM'), 'Junio', 'Normally default to global');
        test.equal(moment([2012, 5, 6]).lang('es').format('MMMM'), 'junio', 'Use the instance specific language');
        test.equal(moment([2012, 5, 6]).format('MMMM'), 'Junio', 'Using an instance specific language does not affect other moments');
