SeriesApp.controller('ConsultaEvaluacionCrtl', function ($scope, $routeParams, $location, GrupoService, $http, $timeout, base_api) {


$scope.title = "Consulta Evaluaciones";
$scope.series = [];
...
$scope.getData = function(){
  $http.get(base_api + "/admin/postconsultaevaluaciones")
    .success(function(response){
