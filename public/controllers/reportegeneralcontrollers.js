...
/***/ "./resources/assets/controllers/reportegeneral/BeneficiariosReporteCrtl.js":
/***/ (function(module, exports) {

SeriesApp.controller('BeneficiariosReporteCrtl', function ($scope, $routeParams, $location, BeneficiarioService, $http, $timeout, base_api) {
  ...
  $scope.getData = function () {
    $http.get(base_api + "/admin/postbeneficiarios").success(function (response) {
      $scope.list = response;
  ...
  $http.get(base_api + "/obtenerselect/instituciones").success(function (response) {

    $scope.instituciones = response;
  });

  $http.get(base_api + "/obtenerselect/sedes").success(function (sedes) {
  ...
  $scope.CargaBeneficiarios = function () {
    ...
    $http({
      url: base_api + '/obtener/beneficiariosgeneral',
      method: "GET",
      params: {
...
module.exports = __webpack_require__("./resources/assets/controllers/reportegeneral/BeneficiariosReporteCrtl.js");
