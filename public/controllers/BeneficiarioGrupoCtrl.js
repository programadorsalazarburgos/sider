    ...
    $scope.selectedVereda = function(veredaselect)
    {
      ...
      .success(function(EstratoVereda){
        console.log(EstratoVereda);
            ...
            $scope.comuna = EstratoVereda.id_comuna;
 ...
 $scope.onBlurDocumento = function($event) {
      ...
      $http.get(base_api + "/admin/postbeneficiarios/cargar/" + no_documento_beneficiario)
        .success(function(response){
	      ...
	      if($scope.ficha.fecha_inscripcion != undefined && $scope.ficha.fecha_inscripcion != null){
          ...
          $scope.tipo_esc = {
            'id': 1,
            'unit': $scope.ficha.escolaridad_id
            }
        ...
        $scope.estado_esc = {
          'id': 1,
          'unit': $scope.ficha.estado_escolaridad
          }

          //Ocupacion Actual
          $scope.tipo_ocup = {
            'id': 1,
            'unit': $scope.ficha.ocupacion_beneficiario
            }
          ...
          $scope.tipo_est = {
            'id': 1,
            'unit': $scope.ficha.id_estado_civil
            }
          ...
          $scope.tipo_disc = {
            ...
            $scope.tipo_medic = {
              ...
              $scope.tipo_condicion = {
                ...
                $scope.acudiente = response.persona[0];
                ...
                $scope.tipo_parent = {
                  'id': 1,
                  'unit': $scope.acudiente.parentesco_acudiente
                  }
          
                  if ($scope.acudiente.parentesco_acudiente == 6) {
