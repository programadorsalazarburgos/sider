...
/***/ "./resources/assets/controllers/reportegeneral/BeneficiariosReporteProgramasCrtl.js":
...
SeriesApp.controller('BeneficiariosReporteProgramasCrtl', function ($scope, $routeParams, $location, BeneficiarioService, $http, $timeout, base_api) {
  ...
  $scope.getData = function () {
    $http.get(base_api + "/admin/postbeneficiariosprogramas").success(function (response) {
      $scope.list = response;
...
module.exports = __webpack_require__("./resources/assets/controllers/reportegeneral/BeneficiariosReporteProgramasCrtl.js");
