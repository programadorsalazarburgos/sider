SeriesApp.controller('CriteriosCrtl', function ($scope, $routeParams, $location, GrupoService, $http, $timeout, base_api) {


$scope.title = "Criterios";
$scope.series = [];
...
swal({
  title: "Estas seguro?",
  text: "Desea inactivar este grupo!",
  type: "warning",
  showCancelButton: true,
  confirmButtonColor: "#DD6B55",
  confirmButtonText: "Si, Inactivalo!",
  cancelButtonText: "No, lo Inactives!",
  closeOnConfirm: false,
  closeOnCancel: false
},
function(isConfirm){
...
swal({
  title: "Estas seguro?",
  text: "Desea activar este grupo!",
  type: "warning",
  showCancelButton: true,
  confirmButtonColor: "#DD6B55",
  confirmButtonText: "Si, activalo!",
  cancelButtonText: "No, lo actives!",
  closeOnConfirm: false,
  closeOnCancel: false
},
function(isConfirm){
