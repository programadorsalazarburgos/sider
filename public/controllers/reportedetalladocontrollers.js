...
/***/ "./resources/assets/controllers/reportedetallado/BeneficiariosReporteDetalladoCrtl.js":
...
SeriesApp.controller('BeneficiariosReporteDetalladoCrtl', function ($scope, $routeParams, $location, BeneficiarioService, $http, $timeout, base_api) {
  ...
  $scope.getData = function () {
    $http.get(base_api + "/admin/postbeneficiariosall").success(function (response) {
      $scope.list = response;
...
module.exports = __webpack_require__("./resources/assets/controllers/reportedetallado/BeneficiariosReporteDetalladoCrtl.js");
