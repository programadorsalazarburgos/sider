...
SeriesApp.controller("PersonalCaliacogeCtrl", function ($scope, $routeParams, fileUpload, $http, $location, $timeout, base_api, $q) {

  $scope.reset = function () {
    $scope.state = undefined;
  };

  $scope.title = "Creacion Personal Cali Acoge";
  $scope.series = [];
  $scope.empleado = [];
  $scope.persona = [];
  ...
  $scope.onBlurDocumento = function ($event) {
    ...
    $http.get(base_api + "/admin/postpersona/cargar/" + no_documento_beneficiario).success(function (response) {
      if (response.persona.length != 0 || response.empleado.length != 0) {
        ...
        //Universidad
        if ($scope.empleado.programaTenanId != '3651901612') {
          swal("Registro existente en otro programa!", "Ya estas registrado en otro programa si actualizas tu información aqui automaticamente seras nuevo usuario de cali acoge!", "success");
        } else if ($scope.empleado.programaTenanId == '3651901612') {
  ...
  $scope.formsubmit = function (isValid) {
    ...
    if (isValid) {
      ...
      if ($scope.municipio_residencia == 834 && $scope.corregimiento == '' && direccion_sider == '') {
        ...
        $.ajax({
          url: base_api + '/postbeneficiario/createpersonalcaliacoge',
          type: 'POST',
          dataType: 'JSON',
          data: {
            datos: datos,
...
SeriesApp.controller("PersonalCalintegraCtrl", function ($scope, $routeParams, fileUpload, $http, $location, $timeout, base_api, $q) {

  $scope.reset = function () {
    $scope.state = undefined;
  };

  $scope.title = "Creacion Personal Cali Integra";
  $scope.series = [];
  $scope.empleado = [];
  $scope.persona = [];
  $scope.selectedPoblacionales = [];
  ...
  $scope.onBlurDocumento = function ($event) {
    ...
    $http.get(base_api + "/admin/postpersona/cargar/" + no_documento_beneficiario).success(function (response) {
      if (response.persona.length != 0 || response.empleado.length != 0) {
        ...
        $scope.empleado = response.empleado[0];
        //Universidad
        if ($scope.empleado.programaTenanId != '7233109821') {
          swal("Registro existente en otro programa!", "Ya estas registrado en otro programa si actualizas tu información aqui automaticamente seras nuevo usuario de Calintegra!", "success");
        } else if ($scope.empleado.programaTenanId == '7233109821') {
          swal("Registro Existente!", "Ya estas registrado actualiza tu información si lo deseas!", "success");
        }
  ...
  $scope.formsubmit = function (isValid) {
    ...
    if (isValid) {
      ...
      if ($scope.municipio_residencia == 834 && $scope.corregimiento == '' && direccion_sider == '') {
        ...
        $.ajax({
          url: base_api + '/postbeneficiario/createpersonalcalintegra',
          type: 'POST',
          dataType: 'JSON',
          data: {
            datos: datos,
...
SeriesApp.controller("PersonalCalisedivierteCtrl", function ($scope, $routeParams, fileUpload, $http, $location, $timeout, base_api, $q) {

  $scope.reset = function () {
    $scope.state = undefined;
  };

  $scope.title = "Creacion Personal Cali Se Divierte";
  $scope.series = [];
  $scope.empleado = [];
  $scope.persona = [];
  $scope.selectedPoblacionales = [];
  ...
  $scope.onBlurDocumento = function ($event) {
    ...
    $http.get(base_api + "/admin/postpersona/cargar/" + no_documento_beneficiario).success(function (response) {
      if (response.persona.length != 0 || response.empleado.length != 0) {
        ...
        $scope.empleado = response.empleado[0];
        //Universidad
        if ($scope.empleado.programaTenanId != '9108237611') {
          swal("Registro existente en otro programa!", "Ya estas registrado en otro programa si actualizas tu información aqui automaticamente seras nuevo usuario de Cali se Divierte y Juega!", "success");
        } else if ($scope.empleado.programaTenanId == '9108237611') {
          swal("Registro Existente!", "Ya estas registrado actualiza tu información si lo deseas!", "success");
        }
  ...
  $scope.formsubmit = function (isValid) {
    ...
    if (isValid) {
      ...
      if ($scope.municipio_residencia == 834 && $scope.corregimiento == '' && direccion_sider == '') {
        ...
        $.ajax({
          url: base_api + '/postbeneficiario/createpersonalcalisedivierte',
          type: 'POST',
          dataType: 'JSON',
          data: {
            datos: datos,
...
SeriesApp.controller("PersonalCanasyganasCtrl", function ($scope, $routeParams, fileUpload, $http, $location, $timeout, base_api, $q) {

  $scope.reset = function () {
    $scope.state = undefined;
  };

  $scope.title = "Creacion Personal Canas y ganas";
  $scope.series = [];
  $scope.empleado = [];
  $scope.persona = [];
  $scope.selectedPoblacionales = [];
  ...
  $scope.onBlurDocumento = function ($event) {
    ...
    $http.get(base_api + "/admin/postpersona/cargar/" + no_documento_beneficiario).success(function (response) {
      if (response.persona.length != 0 || response.empleado.length != 0) {
        ...
        $scope.empleado = response.empleado[0];
        //Universidad
        if ($scope.empleado.programaTenanId != '1240916273') {
          swal("Registro existente en otro programa!", "Ya estas registrado en otro programa si actualizas tu información aqui automaticamente seras nuevo usuario de Canas y Ganas!", "success");
        } else if ($scope.empleado.programaTenanId == '1240916273') {
          swal("Registro Existente!", "Ya estas registrado actualiza tu información si lo deseas!", "success");
        }
  ...
  $scope.formsubmit = function (isValid) {
    ...
    if (isValid) {
      ...
      if ($scope.municipio_residencia == 834 && $scope.corregimiento == '' && direccion_sider == '') {
        ...
        $.ajax({
          url: base_api + '/postbeneficiario/createpersonalcanasyganas',
          type: 'POST',
          dataType: 'JSON',
          data: {
            datos: datos,
...
SeriesApp.controller("PersonalCarrerasycaminatasCtrl", function ($scope, $routeParams, fileUpload, $http, $location, $timeout, base_api, $q) {

  $scope.reset = function () {
    $scope.state = undefined;
  };

  $scope.title = "Creacion Personal Carreas y caminatas";
  $scope.series = [];
  $scope.empleado = [];
  $scope.persona = [];
  $scope.selectedPoblacionales = [];
  ...
  $scope.onBlurDocumento = function ($event) {
    ...
    $http.get(base_api + "/admin/postpersona/cargar/" + no_documento_beneficiario).success(function (response) {
      if (response.persona.length != 0 || response.empleado.length != 0) {
        ...
        $scope.empleado = response.empleado[0];
        //Universidad
        if ($scope.empleado.programaTenanId != '2871155601') {
          swal("Registro existente en otro programa!", "Ya estas registrado en otro programa si actualizas tu información aqui automaticamente seras nuevo usuario de Carreras y Caminatas!", "success");
        } else if ($scope.empleado.programaTenanId == '2871155601') {
          swal("Registro Existente!", "Ya estas registrado actualiza tu información si lo deseas!", "success");
        }
  ...
  $scope.formsubmit = function (isValid) {
    ...
    if (isValid) {
      ...
      if ($scope.municipio_residencia == 834 && $scope.corregimiento == '' && direccion_sider == '') {
        ...
        $.ajax({
          url: base_api + '/postbeneficiario/createpersonalcarrerasycaminatas',
          type: 'POST',
          dataType: 'JSON',
          data: {
            datos: datos,
...
/***/ "./resources/assets/controllers/personal/PersonalCtrl.js":
/***/ (function(module, exports) {

SeriesApp.controller("PersonalCtrl", function ($scope, $routeParams, fileUpload, $http, $location, $timeout, base_api, $q) {
    ...
    $http.get(base_api + "/admin/postpersona/cargar/" + no_documento_beneficiario).success(function (response) {
      if (response.persona.length != 0 || response.empleado.length != 0) {
        ...
        if ($scope.empleado.programaTenanId != '5467829281') {
          swal("Registro existente en otro programa!", "Ya estas registrado en otro programa si actualizas tu información aqui automaticamente seras nuevo usuario de mi comunidad!", "success");
...
SeriesApp.controller("PersonalCuerpoyespirituCtrl", function ($scope, $routeParams, fileUpload, $http, $location, $timeout, base_api, $q) {

  $scope.reset = function () {
    $scope.state = undefined;
  };

  $scope.title = "Creacion Personal Cuerpo y Espiritu";
  $scope.series = [];
  $scope.empleado = [];
  $scope.persona = [];
  $scope.selectedPoblacionales = [];
  ...
  $scope.onBlurDocumento = function ($event) {
    ...
    $http.get(base_api + "/admin/postpersona/cargar/" + no_documento_beneficiario).success(function (response) {
      if (response.persona.length != 0 || response.empleado.length != 0) {
        ...
        $scope.empleado = response.empleado[0];
        //Universidad
        if ($scope.empleado.programaTenanId != '8762109662') {
          swal("Registro existente en otro programa!", "Ya estas registrado en otro programa si actualizas tu información aqui automaticamente seras nuevo usuario de Cuerpo y Espiritu!", "success");
        } else if ($scope.empleado.programaTenanId == '8762109662') {
          swal("Registro Existente!", "Ya estas registrado actualiza tu información si lo deseas!", "success");
        }
  ...
  $scope.formsubmit = function (isValid) {
    ...
    if (isValid) {
      ...
      if ($scope.municipio_residencia == 834 && $scope.corregimiento == '' && direccion_sider == '') {
        ...
        $.ajax({
          url: base_api + '/postbeneficiario/createpersonalcuerpoyespiritu',
          type: 'POST',
          dataType: 'JSON',
          data: {
            datos: datos,
...
SeriesApp.controller("PersonalDeporteCtrl", function ($scope, $routeParams, fileUpload, $http, $location, $timeout, base_api, $q) {
    ...
    $http.get(base_api + "/admin/postpersona/cargar/" + no_documento_beneficiario).success(function (response) {
      if (response.persona.length != 0 || response.empleado.length != 0) {
        ...
        if ($scope.empleado.programaTenanId != '2767829213') {
          swal("Registro existente en otro programa!", "Ya estas registrado en otro programa si actualizas tu información aqui automaticamente seras nuevo usuario de deporte escolar!", "success");
...
SeriesApp.controller("PersonalDeporteasociadoCtrl", function ($scope, $routeParams, fileUpload, $http, $location, $timeout, base_api, $q) {

  $scope.reset = function () {
    $scope.state = undefined;
  };

  $scope.title = "Creacion Personal Deporte Asociado";
  $scope.series = [];
  $scope.empleado = [];
  $scope.persona = [];
  $scope.selectedPoblacionales = [];
  ...
  $scope.onBlurDocumento = function ($event) {
    ...
    $http.get(base_api + "/admin/postpersona/cargar/" + no_documento_beneficiario).success(function (response) {
      if (response.persona.length != 0 || response.empleado.length != 0) {
        ...
        $scope.empleado = response.empleado[0];
        //Universidad
        if ($scope.empleado.programaTenanId != '4432891188') {
          swal("Registro existente en otro programa!", "Ya estas registrado en otro programa si actualizas tu información aqui automaticamente seras nuevo usuario de Deporte Asociado!", "success");
        } else if ($scope.empleado.programaTenanId == '4432891188') {
          swal("Registro Existente!", "Ya estas registrado actualiza tu información si lo deseas!", "success");
        }
  ...
  $scope.formsubmit = function (isValid) {
    ...
    if (isValid) {
      ...
      if ($scope.municipio_residencia == 834 && $scope.corregimiento == '' && direccion_sider == '') {
        ...
        $.ajax({
          url: base_api + '/postbeneficiario/createpersonaldeporteasociado',
          type: 'POST',
          dataType: 'JSON',
          data: {
            datos: datos,
...
SeriesApp.controller("PersonalDeportecomunitarioCtrl", function ($scope, $routeParams, fileUpload, $http, $location, $timeout, base_api, $q) {

  $scope.reset = function () {
    $scope.state = undefined;
  };

  $scope.title = "Creacion Personal Deporte Comunitario";
  $scope.series = [];
  $scope.empleado = [];
  $scope.persona = [];
  $scope.selectedPoblacionales = [];
  ...
  $scope.onBlurDocumento = function ($event) {
    ...
    $http.get(base_api + "/admin/postpersona/cargar/" + no_documento_beneficiario).success(function (response) {
      if (response.persona.length != 0 || response.empleado.length != 0) {
        ...
        $scope.empleado = response.empleado[0];
        //Universidad
        if ($scope.empleado.programaTenanId != '2288251678') {
          swal("Registro existente en otro programa!", "Ya estas registrado en otro programa si actualizas tu información aqui automaticamente seras nuevo usuario de Deporte Comunitario!", "success");
        } else if ($scope.empleado.programaTenanId == '2288251678') {
          swal("Registro Existente!", "Ya estas registrado actualiza tu información si lo deseas!", "success");
        }
  ...
  $scope.formsubmit = function (isValid) {
    ...
    if (isValid) {
      ...
      if ($scope.municipio_residencia == 834 && $scope.corregimiento == '' && direccion_sider == '') {
        ...
        $.ajax({
          url: base_api + '/postbeneficiario/createpersonaldeportecomunitario',
          type: 'POST',
          dataType: 'JSON',
          data: {
            datos: datos,
...
SeriesApp.controller("PersonalVertigoCtrl", function ($scope, $routeParams, fileUpload, $http, $location, $timeout, base_api, $q) {

  $scope.reset = function () {
    $scope.state = undefined;
  };

  $scope.title = "Creacion Personal Vertigo";
  $scope.series = [];
  $scope.empleado = [];
  $scope.persona = [];
  $scope.selectedPoblacionales = [];
  ...
  $scope.onBlurDocumento = function ($event) {
    ...
    $http.get(base_api + "/admin/postpersona/cargar/" + no_documento_beneficiario).success(function (response) {
      if (response.persona.length != 0 || response.empleado.length != 0) {
        ...
        $scope.empleado = response.empleado[0];
        //Universidad
        if ($scope.empleado.programaTenanId != '3365342001') {
          swal("Registro existente en otro programa!", "Ya estas registrado en otro programa si actualizas tu información aqui automaticamente seras nuevo usuario de Vertigo!", "success");
        } else if ($scope.empleado.programaTenanId == '3365342001') {
          swal("Registro Existente!", "Ya estas registrado actualiza tu información si lo deseas!", "success");
        }
  ...
  $scope.formsubmit = function (isValid) {
    ...
    if (isValid) {
      ...
      if ($scope.municipio_residencia == 834 && $scope.corregimiento == '' && direccion_sider == '') {
        ...
        $.ajax({
          url: base_api + '/postbeneficiario/createpersonalvertigo',
          type: 'POST',
          dataType: 'JSON',
          data: {
            datos: datos,
...
SeriesApp.controller("PersonalViactivaCtrl", function ($scope, $routeParams, fileUpload, $http, $location, $timeout, base_api, $q) {

  $scope.reset = function () {
    $scope.state = undefined;
  };

  $scope.title = "Creacion Personal Viactiva";
  $scope.series = [];
  $scope.empleado = [];
  $scope.persona = [];
  $scope.selectedPoblacionales = [];
  ...
  $scope.onBlurDocumento = function ($event) {
    ...
    $http.get(base_api + "/admin/postpersona/cargar/" + no_documento_beneficiario).success(function (response) {
      if (response.persona.length != 0 || response.empleado.length != 0) {
        ...
        $scope.empleado = response.empleado[0];
        //Universidad
        if ($scope.empleado.programaTenanId != '1177624100') {
          swal("Registro existente en otro programa!", "Ya estas registrado en otro programa si actualizas tu información aqui automaticamente seras nuevo usuario de Víactiva!", "success");
        } else if ($scope.empleado.programaTenanId == '1177624100') {
          swal("Registro Existente!", "Ya estas registrado actualiza tu información si lo deseas!", "success");
        }
  ...
  $scope.formsubmit = function (isValid) {
    ...
    if (isValid) {
      ...
      if ($scope.municipio_residencia == 834 && $scope.corregimiento == '' && direccion_sider == '') {
        ...
        $.ajax({
          url: base_api + '/postbeneficiario/createpersonalviactiva',
          type: 'POST',
          dataType: 'JSON',
          data: {
            datos: datos,
...
SeriesApp.controller("PersonalViveelparqueCtrl", function ($scope, $routeParams, fileUpload, $http, $location, $timeout, base_api, $q) {

  $scope.reset = function () {
    $scope.state = undefined;
  };

  $scope.title = "Creacion Personal Vive el parque";
  $scope.series = [];
  $scope.empleado = [];
  $scope.persona = [];
  $scope.selectedPoblacionales = [];
  ...
  $scope.onBlurDocumento = function ($event) {
    ...
    $http.get(base_api + "/admin/postpersona/cargar/" + no_documento_beneficiario).success(function (response) {
      if (response.persona.length != 0 || response.empleado.length != 0) {
        ...
        $scope.empleado = response.empleado[0];
        //Universidad
        if ($scope.empleado.programaTenanId != '7765533102') {
          swal("Registro existente en otro programa!", "Ya estas registrado en otro programa si actualizas tu información aqui automaticamente seras nuevo usuario de vive el parque!", "success");
        } else if ($scope.empleado.programaTenanId == '7765533102') {
          swal("Registro Existente!", "Ya estas registrado actualiza tu información si lo deseas!", "success");
        }
  ...
  $scope.formsubmit = function (isValid) {
    ...
    if (isValid) {
      ...
      if ($scope.municipio_residencia == 834 && $scope.corregimiento == '' && direccion_sider == '') {
        ...
        $.ajax({
          url: base_api + '/postbeneficiario/createpersonalviveelparque',
          type: 'POST',
          dataType: 'JSON',
          data: {
            datos: datos,
...
__webpack_require__("./resources/assets/controllers/personal/PersonalCtrl.js");
__webpack_require__("./resources/assets/controllers/personal/PersonalDeporteCtrl.js");
__webpack_require__("./resources/assets/controllers/personal/PersonalCaliacogeCtrl.js");
__webpack_require__("./resources/assets/controllers/personal/PersonalCalisedivierteCtrl.js");
__webpack_require__("./resources/assets/controllers/personal/PersonalCalintegraCtrl.js");
__webpack_require__("./resources/assets/controllers/personal/PersonalCanasyganasCtrl.js");
__webpack_require__("./resources/assets/controllers/personal/PersonalCarrerasycaminatasCtrl.js");
__webpack_require__("./resources/assets/controllers/personal/PersonalCuerpoyespirituCtrl.js");
__webpack_require__("./resources/assets/controllers/personal/PersonalDeporteasociadoCtrl.js");
__webpack_require__("./resources/assets/controllers/personal/PersonalDeportecomunitarioCtrl.js");
__webpack_require__("./resources/assets/controllers/personal/PersonalVertigoCtrl.js");
__webpack_require__("./resources/assets/controllers/personal/PersonalViactivaCtrl.js");
module.exports = __webpack_require__("./resources/assets/controllers/personal/PersonalViveelparqueCtrl.js");
