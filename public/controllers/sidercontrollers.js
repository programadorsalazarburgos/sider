...
/***/ "./resources/assets/controllers/sider/SiderCrtl.js":
/***/ (function(module, exports) {
...
SeriesApp.controller('SiderCrtl', function ($scope, $routeParams, $location, SiderService, $http, $timeout, base_api) {
  ...
  $http.get(base_api + "/programas").success(function (response) {
    console.log(11);
    $scope.programas = response;
  });

  $http.get(base_api + "/obtener/totalbeneficiarios").success(function (response) {
    $scope.totalbeneficiarios = response;
    console.log($scope.totalbeneficiarios);
    console.log(22);
  });

  $http.get(base_api + "/obtener/escenarios").success(function (response) {
    $scope.totalescenarios = response;
    console.log(33);
  });

  $http.get(base_api + "/obtener/disciplinassider").success(function (response) {
    $scope.totaldisciplinas = response;
    console.log(44);
  });

  $http.get(base_api + "/obtener/programasTotal").success(function (response) {
    $scope.totalprogramas = response;
  });

  $http.get(base_api + "/obtener/usuarios_micomunidad").success(function (response) {
    $scope.totalusuarios = response;
  });

  $http.get(base_api + "/obtener/colegios_micomunidad").success(function (response) {
    $scope.totalcolegios = response;
  });

  $http.get(base_api + "/cantidad/sedes_sider").success(function (response) {
  ...
  $scope.MetasPrograma = function () {
    ...
    $http.get(base_api + "/obtener/metasprograma/" + $scope.programa.unit).success(function (response) {
      $scope.metasprogramas = response;
    });
  };

  $http.get(base_api + "/obtener/programasbeneficiarios").success(function (response) {
    ...
    var chart = AmCharts.makeChart("chartdiv", {
      ...
      "theme": "light",
      "marginRight": 70,
      "dataProvider": [$scope.deporvida, $scope.DeporteEscolar, $scope.DeporteAsociado, $scope.CaliIntegra, $scope.CuerpoyEspiritu, $scope.CarrerasyCamintas, $scope.Viactiva, $scope.ViveelParque, $scope.CaliAcoge, $scope.CanasyGanas],
  ...
  $http.get(base_api + "/obtener/comunasbeneficiarios").success(function (response) {
    ...
    var chart = AmCharts.makeChart("chartcomuna", {
      ...
      "dataProvider": [$scope.totalComuna1, $scope.totalComuna2, $scope.totalComuna3, $scope.totalComuna4, $scope.totalComuna5, $scope.totalComuna6, $scope.totalComuna7, $scope.totalComuna8, $scope.totalComuna9, $scope.totalComuna10, $scope.totalComuna11, $scope.totalComuna12, $scope.totalComuna13, $scope.totalComuna14, $scope.totalComuna15, $scope.totalComuna16, $scope.totalComuna17, $scope.totalComuna18, $scope.totalComuna19, $scope.totalComuna20, $scope.totalComuna21, $scope.totalComuna22, $scope.TotalCorregimientos],
...
__webpack_require__("./resources/assets/controllers/sider/SiderCrtl.js");
module.exports = __webpack_require__("./resources/assets/controllers/sider/DescripcionProgramaCtrl.js");
