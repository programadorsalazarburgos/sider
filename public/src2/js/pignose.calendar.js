...
(function($) {
	...
	var languagePack = {
		...
		weeks: {
			en: ['Sun', 'Lunes', 'Tue', 'Wed', 'Thu', 'Fri', 'Sat'],
			ko: ['일', '월', '화', '수', '목', '금', '토'],
			fr: ['Lun', 'Mar', 'Mer', 'Jeu', 'Ven', 'Sam', 'Dim'],
			ch: ['日', '月', '火', '水', '木', '金', '土'],
			de: ['Lunes', 'Die', 'Mit', 'Don', 'Fre', 'Sam', 'Son'],
			jp: ['日', '月', '火', '水', '木', '金', '土'],
		},
		monthsLong: {
			en: ['Enero', 'Febrero', 'Marzo', 'Abril', 'May', 'Jun', 'Julio', 'Agosto', 'Septiembre', 'Octubre', 'Noviembre', 'Diciembre'],
			ko: ['1월', '2월', '3월', '4월', '5월', '6월', '7월', '8월', '9월', '10월', '11월', '12월'],
			fr: ['Janvier', 'Février', 'Mars', 'Avril', 'Mai', 'Juin', 'Juillet', 'Août', 'Septembre', 'Octobre', 'Novembre', 'Décembre'],
			ch: ['1月', '2月', '3月', '4月', '5月', '6月', '7月', '8月', '9月', '10月', '11月', '12月'],
			de: ['Jänner', 'Feber', 'März', 'Abril', 'Mai', 'Juni', 'Juli', 'Agosto', 'Septiembre', 'Oktober', 'Noviembre', 'Dezember'],
