...
SeriesApp.directive('mcToggleActive', function() {
  return {
...
SeriesApp.config(['$routeProvider', function ($routeProvider) {
    $routeProvider.when("/admin/postconsultaevaluaciones", {redirectTo:"/admin/postconsultaevaluaciones"});

    $routeProvider.when("/admin/postconsultaevaluaciones", {
        controller: "ConsultaEvaluacionCrtl",
        templateUrl: "index-consulta-evaluacion"
    });


    $routeProvider.when("/admin/postconsultaevaluaciones/:id", {
        controller: "ConsultaEvaluacionesTotalGrupoCtrl",
        templateUrl: "consulta-evaluaciones"
    });


    $routeProvider.when("/admin/postconsultaevaluaciones/promedio/:id", {
        controller: "ConsultaEvaluacionesPromedioGrupoCtrl",
        templateUrl: "evaluacion-promedio"
    });


    $routeProvider.otherwise("/admin/postconsultaevaluaciones");
}]);
