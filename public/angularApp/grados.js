...
SeriesApp.config(['$routeProvider', function ($routeProvider) {
    $routeProvider.when("/admin/postgrados", {redirectTo:"/admin/postgrados"});

    $routeProvider.when("/admin/postgrados", {
        controller: "GradosCrtl",
        templateUrl: "index-grados"
    });

    $routeProvider.when("/admin/postgrados/create", {
        controller: "CreateGradoCtrl",
        templateUrl: "create-grados"
    });


$routeProvider.when("/admin/postgrados/editando/:id", {
        controller: "EditarGradoCtrl",
        templateUrl: "editar-grados"
    });



    $routeProvider.otherwise("/admin/postgrados");
}]);
