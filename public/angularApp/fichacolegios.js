...
SeriesApp.config(['$routeProvider', function ($routeProvider) {
    $routeProvider.when("/admin/postfichacolegios", {redirectTo:"/admin/postfichacolegios"});

    $routeProvider.when("/admin/postfichacolegios", {
        controller: "FichaColegioCtrl",
        templateUrl: "index-fichacolegios"
    });

    $routeProvider.when("/admin/postfichacolegios/create", {
        controller: "CreateFichaColegioCtrl",
        templateUrl: "create-fichacolegio"
    });
    ...
    $routeProvider.otherwise("/admin/postfichacolegios");
}]);
