...
var SeriesApp = angular.module('SeriesApp', ['ui.bootstrap', 'ngRoute', 'ngResource', 'ngCkeditor','truncate', 'ngMessages', 'selector', 'ui.select', 'timepickerPop', 'angularUtils.directives.dirPagination', 'ui.directives', 'localytics.directives']).constant('API_URL');
...
SeriesApp.config(['$routeProvider', function ($routeProvider) {
    $routeProvider.when("/admin/postreportegeneralprogramas", {redirectTo:"/admin/postreportegeneralprogramas"});

    $routeProvider.when("/admin/postreportegeneralprogramas", {
        controller: "BeneficiariosReporteProgramasCrtl",
        templateUrl: "index-reporte-general-programas"
    });

    $routeProvider.otherwise("/admin/postreportegeneralprogramas");
}]);
