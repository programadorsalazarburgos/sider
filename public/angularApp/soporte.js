...
SeriesApp.config(['$routeProvider', function ($routeProvider) {
    $routeProvider.when("/admin/postsoporte", {redirectTo:"/admin/postsoporte"});

    $routeProvider.when("/admin/postsoporte", {
        controller: "SoporteCrtl",
        templateUrl: "index-soporte"
    });

    $routeProvider.otherwise("/admin/postsoporte");
}]);
