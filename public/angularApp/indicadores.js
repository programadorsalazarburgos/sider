...
var SeriesApp = angular.module('SeriesApp', ['ui.bootstrap', 'ngRoute', 'ngResource', 'ngCkeditor','truncate', 'ngMessages', 'ngPatternRestrict', 'AxelSoft', 'angularUtils.directives.dirPagination', 'localytics.directives', 'chart.js', 'nvd3', 'ng-fusioncharts']).constant('API_URL');
...
SeriesApp.config(['$routeProvider', function ($routeProvider) {
    $routeProvider.when("/admin/postindicadores", {redirectTo:"/admin/postindicadores"});
    ...
    $routeProvider.when("/admin/postindicadores/crear", {
        controller: "CreateIndicadorCtrl",
        templateUrl: "create-indicadores"
    });


    $routeProvider.when("/admin/postindicadores/grafico/:id", {
            controller: "GraficoIndicadorCtrl",
            templateUrl: "grafico-indicadores"
        });


    $routeProvider.otherwise("/admin/postindicadores");
}]);
