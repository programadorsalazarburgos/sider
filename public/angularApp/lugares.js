...
SeriesApp.config(['$routeProvider', function ($routeProvider) {
    $routeProvider.when("/admin/postlugares", {redirectTo:"/admin/postlugares"});

    $routeProvider.when("/admin/postlugares", {
        controller: "LugaresCrtl",
        templateUrl: "index-lugares"
    });

    $routeProvider.when("/admin/postlugares/create", {
        controller: "CreateLugarCtrl",
        templateUrl: "create-lugares"
    });


    $routeProvider.when("/admin/postlugares/editando/:id", {
        controller: "EditarLugarCtrl",
        templateUrl: "editar-lugares"
    });


    $routeProvider.otherwise("/admin/postlugares");
}]);
