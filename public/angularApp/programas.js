...
SeriesApp.config(['$routeProvider', function ($routeProvider) {
    $routeProvider.when("/admin/postprogramas", {redirectTo:"/admin/postprogramas"});

    $routeProvider.when("/admin/postprogramas", {
        controller: "ProgramasCrtl",
        templateUrl: "index-programas"
    });

    $routeProvider.when("/admin/postprogramas/create", {
        controller: "CreateProgramaCtrl",
        templateUrl: "create-programas"
    });


$routeProvider.when("/admin/postprogramas/editando/:id", {
        controller: "EditarProgramaCtrl",
        templateUrl: "editar-programas"
    });



    $routeProvider.otherwise("/admin/postprogramas");
}]);
