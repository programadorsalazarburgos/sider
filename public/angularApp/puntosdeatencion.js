...
SeriesApp.config(['$routeProvider', function ($routeProvider) {
    $routeProvider.when("/admin/postpuntoatencion", {redirectTo:"/admin/postpuntoatencion"});

    $routeProvider.when("/admin/postpuntoatencion", {
        controller: "PuntosAtencionCrtl",
        templateUrl: "index-puntoatencion"
    });

    $routeProvider.when("/admin/postpuntoatencion/create", {
        controller: "CreatePuntoAtencionCtrl",
        templateUrl: "create-puntoatencion"
    });


$routeProvider.when("/admin/postpuntoatencion/editando/:id", {
        controller: "EditarPuntoAtencionCtrl",
        templateUrl: "editar-puntoatencion"
    });



    $routeProvider.otherwise("/admin/postpuntoatencion");
}]);
