...
var SeriesApp = angular.module('SeriesApp', ['ui.bootstrap', 'ngRoute', 'ngResource', 'ngCkeditor','truncate', 'ngMessages', 'akoenig.deckgrid', 'AxelSoft', 'localytics.directives', 'chart.js', 'nvd3', 'ng-fusioncharts']).constant('API_URL');
