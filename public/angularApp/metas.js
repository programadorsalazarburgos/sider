...
SeriesApp.config(['$routeProvider', function ($routeProvider) {
    $routeProvider.when("/admin/postmetas", {redirectTo:"/admin/postmetas"});

    $routeProvider.when("/admin/postmetas", {
        controller: "MetasCrtl",
        templateUrl: "index-metas"
    });

    $routeProvider.when("/admin/postmetas/crear", {
        controller: "CreateMetaCtrl",
        templateUrl: "create-metas"
    });


    $routeProvider.when("/admin/postmetas/editando/:id", {
            controller: "EditarMetaCtrl",
            templateUrl: "editar-metas"
        });


    $routeProvider.otherwise("/admin/postmetas");
}]);
