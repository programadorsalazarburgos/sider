...
SeriesApp.config(['$routeProvider', function ($routeProvider) {
    $routeProvider.when("/admin/postuniversidades", {redirectTo:"/admin/postuniversidades"});

    $routeProvider.when("/admin/postuniversidades", {
        controller: "UniversidadesCrtl",
        templateUrl: "index-universidades"
    });

    $routeProvider.when("/admin/postuniversidades/create", {
        controller: "CreateUniversidadCtrl",
        templateUrl: "create-universidades"
    });


$routeProvider.when("/admin/postuniversidades/editando/:id", {
        controller: "EditarUniversidadCtrl",
        templateUrl: "editar-universidades"
    });



    $routeProvider.otherwise("/admin/postuniversidades");
}]);
