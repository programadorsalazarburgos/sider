...
var SeriesApp = angular.module('SeriesApp', ['ui.bootstrap', 'ngRoute', 'ngResource', 'ngCkeditor','truncate', 'ngMessages', 'ngPatternRestrict', 'AxelSoft', 'angularUtils.directives.dirPagination', 'localytics.directives']).constant('API_URL');
...
SeriesApp.config(['$routeProvider', function ($routeProvider) {
    ...
    $routeProvider.when("/admin/postusuarios/editandoperfil/:id", {
        controller: "EditarUsuarioPerfilCtrl",
        templateUrl: "editar-usuarios-perfil"
    });
