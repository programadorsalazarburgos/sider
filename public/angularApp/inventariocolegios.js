...
SeriesApp.config(['$routeProvider', function ($routeProvider) {
    $routeProvider.when("/admin/postinventariocolegios", {redirectTo:"/admin/postinventariocolegios"});

    $routeProvider.when("/admin/postinventariocolegios", {
        controller: "InventarioColegioCtrl",
        templateUrl: "index-inventariocolegios"
    });

    $routeProvider.when("/admin/postinventariocolegios/create", {
        controller: "CreateInventarioColegioCtrl",
        templateUrl: "create-inventariocolegio"
    });

    $routeProvider.otherwise("/admin/postinventariocolegios");
}]);
