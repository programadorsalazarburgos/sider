...
SeriesApp.config(['$routeProvider', function ($routeProvider) {
    $routeProvider.when("/admin/postreportedetallado", {redirectTo:"/admin/postreportedetallado"});

    $routeProvider.when("/admin/postreportedetallado", {
        controller: "BeneficiariosReporteDetalladoCrtl",
        templateUrl: "index-reporte-detallado"
    });



    $routeProvider.otherwise("/admin/postreportedetallado");
}]);
