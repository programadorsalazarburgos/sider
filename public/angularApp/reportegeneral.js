...
SeriesApp.config(['$routeProvider', function ($routeProvider) {
    $routeProvider.when("/admin/postreportegeneral", {redirectTo:"/admin/postreportegeneral"});

    $routeProvider.when("/admin/postreportegeneral", {
        controller: "BeneficiariosReporteCrtl",
        templateUrl: "index-reporte-general"
    });

    $routeProvider.otherwise("/admin/postreportegeneral");
}]);
