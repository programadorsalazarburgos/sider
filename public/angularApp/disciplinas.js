...
var SeriesApp = angular.module('SeriesApp', ['ui.bootstrap', 'ngRoute', 'ngResource', 'ngCkeditor','truncate', 'ngMessages', 'angularUtils.directives.dirPagination', 'localytics.directives']).constant('API_URL');
...
SeriesApp.config(['$routeProvider', function ($routeProvider) {
    $routeProvider.when("/admin/postdisciplinas", {redirectTo:"/admin/postdisciplinas"});

    $routeProvider.when("/admin/postdisciplinas", {
        controller: "DisciplinasCrtl",
        templateUrl: "index-disciplinas"
    });

    $routeProvider.when("/admin/postdisciplinas/create", {
        controller: "CreateDisciplinaCtrl",
        templateUrl: "create-disciplinas"
    });


    $routeProvider.when("/admin/postdisciplinas/editando/:id", {
        controller: "EditarDisciplinaCtrl",
        templateUrl: "editar-disciplinas"
    });


    $routeProvider.otherwise("/admin/postdisciplinas");
}]);
