...
SeriesApp.config(['$routeProvider', function ($routeProvider) {
    $routeProvider.when("/admin/postmodalidades", {redirectTo:"/admin/postmodalidades"});

    $routeProvider.when("/admin/postmodalidades", {
        controller: "ModalidadesCrtl",
        templateUrl: "index-modalidades"
    });

    $routeProvider.when("/admin/postmodalidades/create", {
        controller: "CreateModalidadCtrl",
        templateUrl: "create-modalidades"
    });


$routeProvider.when("/admin/postmodalidades/editando/:id", {
        controller: "EditarModalidadCtrl",
        templateUrl: "editar-modalidades"
    });



    $routeProvider.otherwise("/admin/postmodalidades");
}]);
