...
var SeriesApp = angular.module('SeriesApp', ['ui.bootstrap', 'ngRoute', 'ngResource', 'ngCkeditor','truncate', 'ngMessages', 'selector', 'ui.select', 'timepickerPop', 'angularUtils.directives.dirPagination', 'ui.directives']).constant('API_URL');
