...
var SeriesApp = angular.module('SeriesApp', ['ui.bootstrap', 'ngRoute', 'ngResource', 'ngCkeditor','truncate', 'ngMessages', 'selector', 'ui.select', 'timepickerPop', 'angularUtils.directives.dirPagination', 'ui.directives', 'shalotelli-angular-multiselect', 'localytics.directives']).constant('API_URL');
...
SeriesApp.config(['$routeProvider', function ($routeProvider) {
    $routeProvider.when("/admin/postreportedetalladoprogramas", {redirectTo:"/admin/postreportedetalladoprogramas"});

    $routeProvider.when("/admin/postreportedetalladoprogramas", {
        controller: "BeneficiariosReporteDetalladoProgramasCrtl",
        templateUrl: "index-reporte-detallado-programa"
    });

    $routeProvider.otherwise("/admin/postreportedetalladoprogramas");
}]);
