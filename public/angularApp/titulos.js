...
SeriesApp.config(['$routeProvider', function ($routeProvider) {
    $routeProvider.when("/admin/posttitulos", {redirectTo:"/admin/posttitulos"});

    $routeProvider.when("/admin/posttitulos", {
        controller: "TitulosCrtl",
        templateUrl: "index-titulos"
    });

    $routeProvider.when("/admin/posttitulos/create", {
        controller: "CreateTituloCtrl",
        templateUrl: "create-titulos"
    });


$routeProvider.when("/admin/posttitulos/editando/:id", {
        controller: "EditarTituloCtrl",
        templateUrl: "editar-titulos"
    });



    $routeProvider.otherwise("/admin/posttitulos");
}]);
