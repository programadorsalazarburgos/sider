...
var SeriesApp = angular.module('SeriesApp', ['ui.bootstrap', 'ngRoute', 'ngResource', 'ngCkeditor','truncate', 'ngMessages', 'selector', 'ngSanitize', 'ui.select', 'angularUtils.directives.dirPagination']).constant('API_URL');
...
SeriesApp.config(['$routeProvider', function ($routeProvider) {
    $routeProvider.when("/admin/postludotecas", {redirectTo:"/admin/postludotecas"});

    $routeProvider.when("/admin/postludotecas", {
        controller: "LudotecasCrtl",
        templateUrl: "index-ludotecas"
    });

    $routeProvider.when("/admin/postludotecas/create", {
        controller: "CreateLudotecaCtrl",
        templateUrl: "create-ludotecas"
    });


   $routeProvider.when("/admin/postludotecas/editando/:id", {
        controller: "EditarLudotecaCtrl",
        templateUrl: "editar-ludotecas"
    });


    $routeProvider.otherwise("/admin/postludotecas");
}]);
